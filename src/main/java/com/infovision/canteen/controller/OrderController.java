...
//	public ResponseEntity<?> getEmpOrders(@RequestBody UUID empId) throws Exception {
//		
//		ResponseEntity<?> response;
//
//		try {
...
//	public ResponseEntity<?> getRestaurantOrders(@RequestBody UUID restId) throws Exception {
//		
//		ResponseEntity<?> response;
//
//		try {
